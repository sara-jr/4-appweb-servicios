            ...
            <div class="header-content clearfix">
                ...
                <div class="header-right">
                    <ul class="clearfix">
                        ...
                        <!-- AQUI SE ENCUENTRAN LAS OPCIONES DE LOGIN, LOGOUT Y VER PERFIL -->
                        <li class="icons dropdown">
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li>
                                            <a href="../vista/perfil.php"><i class="icon-user"></i> <span>Perfil de usuario</span></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void()">
                                        ...
                                        <li><a href="../controlador/cerrar-session.php"><i class="icon-key"></i> <span>Cerrar session</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
